                ...
                <div class="col-md-3">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            ...
                            <?php
                            $conn1 = mysqli_connect("localhost", "root", "", "farel_skripsi");
                ...
                <div class="col-md-3">
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            ...
                            <?php
                            $conn2 = mysqli_connect("localhost", "root", "", "farel_skripsi");
                ...
                <div class="col-md-3">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            ...
                            <?php
                            $conn3 = mysqli_connect("localhost", "root", "", "farel_skripsi");
                ...
                <div class="col-md-3">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            ...
                            <?php
                            $conn4 = mysqli_connect("localhost", "root", "", "farel_skripsi");
                ...
                <div class="panel-body">
                    <div class="list-group">
                        ...
                        <a href="index.php?m=contents&p=kegiatan" class="list-group-item">
                            <?php
                            $conn5 = mysqli_connect("localhost", "root", "", "farel_skripsi");
