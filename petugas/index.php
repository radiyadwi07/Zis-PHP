...
<head>
    <meta charset="UTF-8" />
    <title>Petugas Musholla | Dashboard </title>
...
<body class="padTop53 ">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top " style="padding-top: 10px;">
                ...
                <header class="navbar-header">
                    <a href="index.php" class="navbar-brand">
                        <b class="text-primary">Musholla Al hidayah Kenikir</b>
                    </a>
                </header>
                <!-- END LOGO SECTION -->
    ...
    <!-- FOOTER -->
    <div id="footer">
        <p>&copy; Design and Created By <b class="text-danger">Rizky Farel</b> &nbsp;<?php echo date('Y'); ?> &nbsp;</p>
    </div>
    <!--END FOOTER -->
